package io.kestra.plugin.aws-lib;
    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.aws-lib.AwsLibTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class AwsLibTask extends Task implements RunnableTask<AwsLibTask.Output> {
    @Schema(
    ...
    @Override
    public AwsLibTask.Output run(RunContext runContext) throws Exception {
